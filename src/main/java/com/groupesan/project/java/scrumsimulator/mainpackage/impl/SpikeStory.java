...
public class SpikeStory {
    ...
    public static void createSpikeStory(List<String> developerList, Double pointsValue, String userStoryName) {
        ...
        for(String name:developerList){
            developerNames.append(name).append("\n");
        }
        UserStory userStory = new UserStory("Spike Story", "This is a spike story,created when a user story is blocked by another one",
                pointsValue, blockedUserStory.getBusinessValue(), "in progress",null);
