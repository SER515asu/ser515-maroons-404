...
public class UserStoryStoreTest {
  ...
  public void testSetUserStories() {
    UserStory userStory =
        new UserStory("test", "setting user story from test class", 0.0, 2.0, "new", null, null);
  ...
  public void testAddUserStory() {
    userStoryStore.addUserStory(
        new UserStory("test", "setting user story from test class", 0.0, 3.0, "new", null, null));
  }
  ...
  public void testRemoveUserStory() {
    UserStory userStory =
        new UserStory(
            "test", "setting user story from test class", 0.0, 12.0, "backlog", null, null);
    List<UserStory> userStories = new ArrayList<>();
